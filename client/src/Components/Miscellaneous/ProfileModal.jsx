...
const ProfileModal = ({ user, children }) => {
    ...
    const onFileSelect = (e) => {
        ...
        if (file.type !== 'image/jpeg' && file.type !== 'image/png' && file.type !== 'image/jpg') {
            return toast.warning("Please select a valid image (JPEG/PNG)");
        }
    ...
    const performUpload = async (croppedFile) => {
        ...
        try {
            ...
            if (!imgData.success) {
                setImgLoading(false);
                return toast.error("ImgBB Upload Failed");
            }
        ...
        <>
            ...
            {isOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
                    ...
                    <div className="relative inline-block align-bottom bg-[#1a1a1a] border border-white/10 rounded-xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full z-10">
